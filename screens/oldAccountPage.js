  ...
  render(){
    return (
      ...
      <View style={{flex:1,height:'100%'}}>
        ...
        <View style={{height:'70%', width:wp('100%'),flexDirection:'row',justifyContent:'space-evenly'}}>
          <View style={{margin:4,width:wp('37%'), flexDirection:'column'}}>
            ...
            <TextInput
              ...
              />
            <Text style={{marginTop:7,fontSize:23,width:wp('40%')}}><Icon name='lock' color='black' size={30}/> Password:</Text>
            <TextInput
          ...
          <Text style={{fontSize:23, width:wp('40%')}}><MatIcon name='email' color='black' size={30}/> Email:</Text>
            <TextInput
             ...
             />
            <Text style={{marginTop:7,width:wp('40%'),fontSize:23}}><MatIcon name='map-marker-radius' color='black' size={30}/> Job City:</Text>
            <Autocomplete
              ...
              />
              <Button onPress={() => {this.createAccount()} } style={{width:wp('40%'),alignSelf:'center'}} type='outline' title='Sign Up'/>
          </View>
